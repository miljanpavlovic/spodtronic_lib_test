...
public class MainActivity extends Activity implements View.OnClickListener, PlayerCallback {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        if (history.size() == 0 ) {
            ...
            history.addUrl( "http://playerservices.streamtheworld.com/pls/SPORT1FM_24_7_low.pls" );
            history.addUrl( "http://pmd2.sport1.de/p/20150615/0/0_sz2shld0_0_vpik7x7z_2.mp3" );
        }
